...
import com.kundalinisoftware.PianoMirrorGooglePlay.miditools.MidiConstants;
import com.kundalinisoftware.PianoMirrorGooglePlay.miditools.MidiDeviceMonitor;
...
public abstract class MidiPortSelector extends DeviceCallback {
    ...
    public void onDeviceAdded(final MidiDeviceInfo info) {
        ...
        for (int i = 0; i < portCount; ++i) {
            ...
            Log.i("MidiTools", wrapper + " was added to " + this);
    ...
    public void onDeviceRemoved(final MidiDeviceInfo info) {
        ...
        for (int i = 0; i < portCount; ++i) {
            ...
            mAdapter.notifyDataSetChanged();
            Log.i("MidiTools", wrapper + " was removed");
        }
    }
    ...
    public void onDeviceStatusChanged(final MidiDeviceStatus status) {
        ...
        if (mType == MidiDeviceInfo.PortInfo.TYPE_INPUT) {
            ...
            Log.i("MidiTools", "MidiPortSelector.onDeviceStatusChanged status = " + status
                    + ", mType = " + mType
